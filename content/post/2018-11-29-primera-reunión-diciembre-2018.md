...
<img src="/post/2018-11-29-primera-reunión-diciembre-2018_files/guRM_primera.jpg" alt="cartel primera reunión" width="90%"/>

La reunión constará de dos partes:

- En la primera, contaremos cómo estamos organizando el grupo y haremos planes de cara al futuro (próximas reuniones, temáticas de interés para las sucesivas charlas...).
- En la segunda parte, habrá una charla sobre casos de uso de R en el ámbito de Machine Learning. Un recorrido con ejemplos de diversas técnicas de Aprendizaje Computacional, uno de los campos más en auge, y de gran importancia en la actualidad en el mundo empresarial.
